module DotaBot
  class Report
    def self.since_last_reported
      ...
      # require 'net/http'
      # postData = Net::HTTP.post_form(URI.parse('https://hooks.slack.com/services/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'), {'payload'=>'{"text": "payload test."}'})
      # puts postData.body
